export default function (
  ...
  lazyLoad(import("../image/image.module.js")).then(
    (mod) => ($scope.lazyLoadImage = mod),
  );
  ...
  $scope.$watch("imageId", async function () {
    ...
    const response = await fetch(
      `${arachneSettings.hacViaUrl}/api/published/access_info/${$stateParams.imageId}`,
    );
