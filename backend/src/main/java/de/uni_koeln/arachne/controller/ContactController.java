...
public class ContactController {
	...
	/**
	 * Constructor setting the default contact email address from the
	 ...
	 * 
	 * @param contactInformation The contact information, namely 'name', 'email',
	 *                           'subject' and 'message'.
	 * @param response           The outgoing HTTP response.
	 */
	@ResponseBody
	@PostMapping(value = "/contact", consumes = { APPLICATION_JSON_UTF8_VALUE })
	 ...
	 * @return A HTTP response with status 'bad request' and an error message as
	 *         body.
	 */
	@ResponseBody
