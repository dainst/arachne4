...
public class SearchController {
    ...
    @RequestMapping(value = "/search/scroll/{scrollId}",
            ...
            produces = {APPLICATION_JSON_UTF8_VALUE})
    public @ResponseBody
    ResponseEntity<?> handleSearchScrollRequest(@PathVariable("scrollId") final String scrollId) {
    ...
    @RequestMapping(value = "/index/{categoryName}/{facetName}",
            ...
            produces = {APPLICATION_JSON_UTF8_VALUE})
    public @ResponseBody
    ResponseEntity<IndexResult> handleIndexRequest(@PathVariable("facetName") final String facetName, @PathVariable("categoryName") final String categoryName, @RequestParam(value = "group", required = false) Character groupMarker) {
