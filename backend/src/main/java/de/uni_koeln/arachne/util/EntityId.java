...
public class EntityId {
	 ...
	 * @param degree          The degree (a value for the 'quality' of an entity
	 *                        based on connected images and entities as well
	...
	/**
	 * This Constructor gets an ArachneEntity retrieved from hibernate and uses its
	 * information to construct
	 * an EntityId
	 * 
	 * @param entity ArachneEntity Retrieved Hibernate-record from
