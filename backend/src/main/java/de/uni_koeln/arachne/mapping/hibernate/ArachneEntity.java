...
public class ArachneEntity {
	 ...
	 * This is the primary key of the table referenced in the <code>TableName</code>
	 * field.
	 */
	...
	/**
	 * Field indicating if the referenced data record has been deleted
	 * (<code>isDeleted</code>).
	 * This is used to keep URLs persistent even if the corresponding data record
	 * has been deleted.
	 */
	 ...
	 * This allows retrieving the new Entity for the image if the old Entity has
	 * been deleted
