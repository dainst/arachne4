...
public class SingleEntityDataService {
	 ...
	 * If an entity does not have a dataset group () <code>"Arachne"</code> is
	 * returned.
	 * 
	 * @param arachneId The id of the entity of interest.
	 * @return The dataset group of the entity or "Arachne" for tables without a
	 *         dataset group.
	 */
	...
	public Dataset getSingleEntityByArachneId(final EntityId entityId) {
		...
		// If there are Arachne categories that require the retrieval of other tables
		// than the table of the category
