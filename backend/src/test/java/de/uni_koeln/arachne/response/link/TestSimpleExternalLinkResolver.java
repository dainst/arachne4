...
public class TestSimpleExternalLinkResolver {
	...
	public void setUp() {
		...
		resolver.setLinkPattern(
				"https://arachne.uni-koeln.de/browser/index.php?view[layout]=sarkophag_item&sarkophag[jump_to_id]=%s");
	...
	public void testResolveOneCriterion() {
		...
		assertEquals(
				"https://arachne.uni-koeln.de/browser/index.php?view[layout]=sarkophag_item&sarkophag[jump_to_id]=23",
				link1.getUrl());

		assertNotNull(link2);
		assertEquals("Sarkophagbrowser", link2.getLabel());
		assertEquals(
				"https://arachne.uni-koeln.de/browser/index.php?view[layout]=sarkophag_item&sarkophag[jump_to_id]=42",
				link2.getUrl());
	...
	public void testResolveOr() {
		...
		assertEquals(
				"https://arachne.uni-koeln.de/browser/index.php?view[layout]=sarkophag_item&sarkophag[jump_to_id]=7",
				link3.getUrl());
	...
	public void testResolveComma() {
		...
		assertEquals(
				"https://arachne.uni-koeln.de/browser/index.php?view[layout]=sarkophag_item&sarkophag[jump_to_id]=56",
				link4.getUrl());
