...
public class TestCatalogEntryDao {
	...
	// assertEquals("child test label level 1 No. 1",
	// childrenLevel1.get(0).getLabel());
	// assertFalse(childrenLevel1.get(0).hasChildren());
	// assertEquals("child test label level 1 No. 2",
	// childrenLevel1.get(1).getLabel());
	// assertTrue(childrenLevel1.get(1).hasChildren());
	// assertEquals("child test label level 1 No. 3",
	// childrenLevel1.get(2).getLabel());
	// assertFalse(childrenLevel1.get(2).hasChildren());
	//
	// final List<CatalogEntry> childrenLevel2 =
	// childrenLevel1.get(1).getChildren();
	// assertNotNull(childrenLevel2);
	// assertEquals(1, childrenLevel2.size());
	// assertEquals("child test label level 2 No. 1",
	// childrenLevel2.get(0).getLabel());
	// assertTrue(children.get(0).hasChildren());
	// }
	...
	public void testGetChildrenByParentId() {
		final List<CatalogEntry> catalogEntries = catalogEntryDao.getChildrenByParentId(8L,
				catalogEntryDao::mapCatalogEntryNoChilds);
