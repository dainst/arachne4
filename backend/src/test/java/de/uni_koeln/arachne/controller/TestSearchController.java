...
public class TestSearchController {
        ...
        public void setUp() throws Exception {
                ...
                // this is a neat trick to get a final, mutable boolean value which I can
                // reference in the overriden answer
                // methods
                ...
                when(searchService.buildDefaultSearchRequest(any(SearchParameters.class), any(Multimap.class),
                                ...
                                .then(new Answer<SearchRequestBuilder>() {
                                        @Override
                                        public SearchRequestBuilder answer(InvocationOnMock invocation)
                                                        throws Throwable {
                                                ...
                                                if (resultSize > offset) {
                                                        final int toIndex = (limit + offset) > resultSize ? resultSize
                                                                        : (limit + offset);
                                                ...
                                                if (facetLimit > 0) {
                                                        ...
                                                        for (SearchResultFacet facet : searchResult.getFacets()) {
                                                                List<SearchResultFacetValue> facetValues = facet
                                                                                .getValues();
                                                                if (facetValues.size() > facetLimit) {
                                                                        facetValues = facetValues.subList(0,
                                                                                        facetLimit);
                                                                        final SearchResultFacet newFacet = new SearchResultFacet(
                                                                                        facet.getName());
                                                                        ...
                                                                        if (searchParams.getFacetsToSort()
                                                                                        .contains(facet.getName())) {
                                                                                Collections.sort(facetValues,
                                                                                                new FacetValueComparator());
                                                                        }
                                                                        newFacets.add(facet);
                                                                }
                                                        }
                ...
                when(searchService.buildContextSearchRequest(anyLong(), any(SearchParameters.class),
                                any(Multimap.class), anyString()))
                                .then(new Answer<SearchRequestBuilder>() {
                                        @Override
                                        public SearchRequestBuilder answer(InvocationOnMock invocation)
                                                        throws Throwable {
                                                ...
                                                if (entityId != 1) {
                                                        ...
                                                        if (resultSize > offset) {
                                                                final int toIndex = (limit + offset) > resultSize
                                                                                ? resultSize
                                                                                : (limit + offset);
                                                                searchResult.setEntities(
                                                                                entities.subList(offset, toIndex));
                                                        ...
                                                        if (facetLimit > 0) {
                                                                final List<SearchResultFacet> newFacets = new ArrayList<SearchResultFacet>();
                                                                for (SearchResultFacet facet : searchResult
                                                                                .getFacets()) {
                                                                        List<SearchResultFacetValue> facetValues = facet
                                                                                        .getValues();
                                                                        if (facetValues.size() > facetLimit) {
                ...
                when(searchService.buildIndexSearchRequest(anyString(), anyString(), any(Multimap.class)))
                                .then(new Answer<SearchResult>() {
                                        ...
                                        public SearchResult answer(InvocationOnMock invocation) throws Throwable {
                                                final String facetName = invocation.getArgument(1, String.class);
                                                ListIterator<SearchResultFacet> iterator = searchResult.getFacets()
                                                                .listIterator();
                ...
                when(searchService.executeSearchRequest(eq((SearchRequestBuilder) null), anyInt(), anyInt(),
                                any(Multimap.class), anyInt(), any(SearchParameters.class)))
                                .then(new Answer<SearchResult>() {
                                        @Override
                                        public SearchResult answer(InvocationOnMock invocation) throws Throwable {
                                                final Object[] args = invocation.getArguments();
                                                ...
                                                if (args[3] != null) {
                                                        final Multiset<String> keyMultiset = ((Multimap<String, String>) args[3])
                                                                        .keys();
        ...
        public void testSearchLimit() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("limit", "1")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchLimit0() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("limit", "0")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchLimit2() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("limit", "2")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchOffset() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("offset", "1")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchFq() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("fq", "facet_test2:\"test2_value1\"")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchFqUnknownFacet() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("fq", "facet_unknown:\"some value\"")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchFqInvalidFacet() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("fq", "f,a:c,e+t")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchFl() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "debug").param("fl", "1")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchFlLimit0() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "debug").param("fl", "0")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchSort() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("sort", "title")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchDesc() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("desc", "true")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchBbox() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("bbox", "0,0,1,1")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchGhprec() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("ghprec", "1")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchSortFacet() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("sf", "facet_test1")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
        ...
        public void testSearchSortFacetInvalidUnknownFacet() throws Exception {
                mockMvc.perform(
                                get("/search.json").param("q", "*").param("sf", "unknown")
                                                .contentType(APPLICATION_JSON_UTF8))
                                .andExpect(status().isOk())
                                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                                .andExpect(content().json("{"
